# Template: .atk/runner/test_runner.py

Copy this template into `.atk/runner/test_runner.py` and replace every `TODO_AGENT_TUNING` block after the `atk-setup` Skill has inspected the target Agent and dataset. The generated script should stay low-dependency and project-local.
...
- Writes results incrementally to .atk/results/vN/results.csv.
