...
REQUIRED_FILES = [
    ...
    "skills/atk-tune-ground-truth/SKILL.md",
    "skills/atk-tune-ground-truth/scripts/tune_ground_truth.py",
    ...
    "skills/atk-visualize-failures/assets/page.html",
...
PER_FILE_PHRASES = {
    ...
    "skills/atk-build-dataset/SKILL.md": [
        ...
        "expected output, acceptance standard",
        ...
        "Do not infer or invent a canonical `ground_truth` column by default",
        "Only write `ground_truth` when the user explicitly",
        "clear judgment policy",
        "ask 1-3 targeted questions",
        "input fields are unclear",
        "expected-output or correct-result semantics are unclear",
        "a `ground_truth` column would require guessing",
    ...
    "skills/atk-tune-ground-truth/SKILL.md": [
        ...
        "review_feedback",
        "Downloads",
        "Do not use fingerprint validation",
        "corrected `ground_truth`",
        "Do not copy the feedback text directly",
    ...
    "skills/atk-tune-ground-truth/scripts/tune_ground_truth.py": [
        ...
        "def parse_updates_csv(",
        "def write_dataset_atomic(",
        "os.replace",
        "--dump-context",
        "--updates-path",
        "unknown atk_id values",
    ],
    "skills/atk-init/SKILL.md": [
        ...
        "Agent invocation, dataset path/format, log source, Python logger names, invalid `atk_id`, or `agent_output` / `log_path` column conflict",
    ...
    "skills/atk-visualize-failures/SKILL.md": [
        ...
        "HISTORY_FAILURE_MAX_BYTES",
        "HISTORY_EVAL_MAX_BYTES",
        "HISTORY_TUNING_PLAN_MAX_BYTES",
    ],
    "skills/atk-visualize-failures/scripts/generate_failure_browser.py": [
        'RESULTS_DIR = Path(".atk/results")',
...
def main() -> int:
    ...
    require(
        'AGENT_OUTPUT_LOG_PATH_FIELD = "log_path"' in runner_template,
        "runner template must define stable log_path field",
        errors,
    )
    require(
    ...
    require(
        ...
        "runner template must guard log_path source conflicts",
        errors,
    )
    require(
